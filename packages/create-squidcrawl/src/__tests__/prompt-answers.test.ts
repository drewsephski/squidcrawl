...
test('resolveProjectLocation builds the target directory from the parent directory', () => {
  assert.deepEqual(
    resolveProjectLocation({
      cwd: '/Users/felix/Desktop/felix-projects/squidcrawl',
...
test('resolveProjectLocationFromTargetPath derives name and parent directory', () => {
  assert.deepEqual(
    resolveProjectLocationFromTargetPath({
      cwd: '/Users/felix/Desktop/felix-projects/squidcrawl',
      targetPath: '../test-create-squidcrawl',
    }),
    {
      projectName: 'test-create-squidcrawl',
      parentDirectory: '..',
      requestedProjectName: 'test-create-squidcrawl',
      requestedTargetPath: '../test-create-squidcrawl',
      targetDirectory:
        '/Users/felix/Desktop/felix-projects/test-create-squidcrawl',
    },
  );
});
