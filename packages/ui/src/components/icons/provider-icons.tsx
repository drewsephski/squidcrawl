...
export const DiscordIcon: ProviderIcon = ({ className, variant }) =>
  variant === 'color' ? (
    <svg
      className={className}
      viewBox="0 0 256 199"
...
export const DropboxIcon: ProviderIcon = ({ className, variant }) =>
  variant === 'color' ? (
    <svg
      className={className}
      viewBox="0 0 256 218"
...
export const GitLabIcon: ProviderIcon = ({ className, variant }) =>
  variant === 'color' ? (
    <svg
      className={className}
      viewBox="0 0 256 236"
...
export const LinkedInIcon: ProviderIcon = ({ className, variant }) =>
  variant === 'color' ? (
    <svg
      className={className}
      viewBox="0 0 128 128"
...
export const MicrosoftIcon: ProviderIcon = ({ className, variant }) =>
  variant === 'color' ? (
    <svg
      className={className}
      viewBox="0 0 256 256"
...
export const RedditIcon: ProviderIcon = ({ className, variant }) =>
  variant === 'color' ? (
    <svg
      className={className}
      viewBox="0 0 256 256"
...
export const SpotifyIcon: ProviderIcon = ({ className, variant }) =>
  variant === 'color' ? (
    <svg
      className={className}
      viewBox="0 0 256 256"
...
export const TikTokIcon: ProviderIcon = ({ className, variant }) =>
  variant === 'color' ? (
    <svg
      className={className}
      viewBox="0 0 256 290"
...
export const TwitchIcon: ProviderIcon = ({ className, variant }) =>
  variant === 'color' ? (
    <svg
      className={className}
      id="Layer_1"
...
export const InstagramIcon: ProviderIcon = ({ className }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    xmlns="http://www.w3.org/2000/svg"
...
export const ZoomIcon: ProviderIcon = ({ className, variant }) =>
  variant === 'color' ? (
    <svg
      className={className}
      height={117}
