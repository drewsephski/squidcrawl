  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[10px] text-sm font-medium transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        indigo:
          "bg-[#6366f1] text-white hover:bg-[#4f46e5] [box-shadow:inset_0px_-2px_0px_0px_#4338ca,_0px_1px_6px_0px_rgba(99,_102,_241,_58%)] hover:translate-y-[1px] hover:scale-[0.98] hover:[box-shadow:inset_0px_-1px_0px_0px_#4338ca,_0px_1px_3px_0px_rgba(99,_102,_241,_40%)] active:translate-y-[2px] active:scale-[0.97] active:[box-shadow:inset_0px_1px_1px_0px_#4338ca,_0px_1px_2px_0px_rgba(99,_102,_241,_30%)] disabled:shadow-none disabled:hover:translate-y-0 disabled:hover:scale-100",
        outlineDark:
          "border border-[#3f3f46] bg-transparent hover:bg-[#1a1a25] text-[#fafafa] [box-shadow:inset_0px_-2px_0px_0px_#27272a,_0px_1px_6px_0px_rgba(39,_39,_42,_58%)] hover:translate-y-[1px] hover:scale-[0.98] hover:[box-shadow:inset_0px_-1px_0px_0px_#27272a,_0px_1px_3px_0px_rgba(39,_39,_42,_40%)] active:translate-y-[2px] active:scale-[0.97] active:[box-shadow:inset_0px_1px_1px_0px_#27272a,_0px_1px_2px_0px_rgba(39,_39,_42,_30%)] disabled:shadow-none disabled:hover:translate-y-0 disabled:hover:scale-100",
        ghost:
