---
title: Introduction
description: Squidcrawl is an agents-oriented web page context extraction platform. Open Source. Open Code.
---

<LogoText  description="Squidcrawl is a 100% free, no-pricing, and fully open-source toolkit for agents to make any website data AI ready" />


<Callout type="warn" title="ACTIVE DEVELOPMENT WARNING!!">
Squidcrawl is under active development and early-stage. All APIs and SDKs are subject to change. Many planned features are coming soon. Use at your own risk.
</Callout>
...
<Callout type="info">
Squidcrawl is free and open-source [Firecrawl](https://www.firecrawl.dev) alternative with even better performance, flexibility and transparency.
</Callout>
...
## What technologies make Squidcrawl possible
...
- **[Zod v4](https://zod.dev):** Shared schema library that enforces type safety
  ...
  `squidcrawl/zod/v4` as an app-level helper can share the same runtime instance.
...
- **Online Playground:** Try Squidcrawl instantly in the browser, tweak options, and copy shareable URLs—see the [playground guide](/docs/usage/playground) for details.

## Deploy on your own terms
Squidcrawl ships with everything you need to self-host: deploy the dashboard to Vercel, the workers to Cloudflare, and you have a complete system without paid dependencies. Fork it, extend it, or plug it into your existing stack—the licenses and tooling encourage customization.
