...
![Get Markdown example](../../assets/get-markdown-example.png)

## When to use this endpoint
- You only need the markdown representation of a page (no metadata or link tree).
- The page is public and can be handled by Squidcrawl’s scraping pipeline.
...
curl \
  ...
  "https://api.squidcrawl.dev/read?url=https://example.com&...getMarkdownOptions" // see below
```
